...
const createCompanyQueueRouter = require("./createCompanyQueueRouter");
const serversQueueRouter = require("./serversQueueRouter");
...
const gillieProfileRouter = require("./trails/gillieProfileRouter");
const listRouter = require("./lists/listRouter");
const blazorRouter = require("./blazorRouter");
const filesRouter = require("./blazor/filesRouter");
...
router.use("/gillieProfile", gillieProfileRouter);
router.use("/list", listRouter);
router.use("/queue", createCompanyQueueRouter);
router.use("/serverQueue", serversQueueRouter);
router.use("/blazor", blazorRouter);
