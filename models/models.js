...
const Cities = sequelize.define("city", {
  ...
  day_1_date: { type: DataTypes.STRING },
  day_1_numbers_for_1_consent: { type: DataTypes.INTEGER },
  day_1_topical_quantity_invites: { type: DataTypes.INTEGER },
  day_2_date: { type: DataTypes.STRING },
  day_2_numbers_for_1_consent: { type: DataTypes.INTEGER },
  day_2_topical_quantity_invites: { type: DataTypes.INTEGER },
  day_3_date: { type: DataTypes.STRING },
  day_3_numbers_for_1_consent: { type: DataTypes.INTEGER },
  day_3_topical_quantity_invites: { type: DataTypes.INTEGER },
...
const KzCities = sequelize.define("kzcity", {
  ...
  day_2_topical_quantity_invites: { type: DataTypes.INTEGER },
  day_3_date: { type: DataTypes.STRING },
  day_3_numbers_for_3_consent: { type: DataTypes.INTEGER },
  day_3_topical_quantity_invites: { type: DataTypes.INTEGER },
  vip_id: { type: DataTypes.STRING },
  vip_format: { type: DataTypes.STRING },
  vip_limit: { type: DataTypes.STRING },
